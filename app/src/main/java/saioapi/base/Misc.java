...
public class Misc
{
     ...
     * on the interested entries (only for secure system).
     * <p>Remarks:<br />
    ...
    /**
     * This method retrieves the current configuration of the Android system log filter (only for secure system).
     * @param filter The data array contains null terminated string of the new log filter configuration.
     * @return Return zero if there is no error else nonzero error code defined in class constants.
     */
     ...
     * format and copies to a user specified file for viewing (only for secure system).
