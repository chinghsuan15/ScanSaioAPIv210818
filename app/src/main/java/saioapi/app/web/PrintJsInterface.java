...
final public class PrintJsInterface implements SaioJsInterface
{
    ...
    private final Object _lockDoPrint = new Object();
    private final Object _lockIsPrinting = new Object();
    ...
    private class PrintJobThread extends Thread
    {
        ...
        private final Object _lockDoStop = new Object();
